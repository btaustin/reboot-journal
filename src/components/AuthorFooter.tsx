      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 bg-muted/30 p-8 rounded-2xl">
        ...
        <div className="flex-1 text-center sm:text-left">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Brandon is a software engineering leader with over two decades of experience. 
            He focuses on architecting resilient systems and building high-performance engineering cultures.
          </p>
